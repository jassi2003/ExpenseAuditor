...
import { startLiveAuditFeed } from "../stylesheets/services/liveAuditFeed.js";
...
const allEmployeesBtn = document.querySelector("#AllEmpBtn");
const allEmpPage = document.querySelector("#AllEmpPage");

// WS Live Audit Feed UI
const auditFeedList = document.querySelector("#auditFeedList");
